...
struct ClueCardView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // together rather than help. See PROJECT.md's "Hermann Grid
            // Mitigation" addendum and BoardGridDensity.swift.
    ...
    private var cardContent: some View {
        ...
        // PROJECT.md's "Hermann Grid Mitigation" addendum.
    ...
    /// that response. See PROJECT.md's "Hermann Grid Mitigation" addendum.
